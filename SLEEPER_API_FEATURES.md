...
**Season Context**: The app pulls from the **current 2026 league year** by default (configurable via `SEASON_CONTEXT.league_year`). This ensures you're analyzing your current league rosters, whether in preseason, regular season, or playoffs. The system automatically syncs with your active Sleeper leagues for the current season.
...
```python
{
  ...
  'season': '2026',  # Current league year
  'status': 'in_season',
  'scoring_settings': {
    'rec': 1.0,  # Full PPR
